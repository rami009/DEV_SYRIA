...
if not tostring(SUDO):match('%d+') then
  ...
  config = {
   ...
   "plugins",
    ...
    master_id = SUDO, 
    token_bot = token, 
    botname = (botname or "الدولة"), 
    sudouser = (sudouser or "@RAMBO_SYR"), 
...
function load_config( )
  ...
  if not f then
    print ("\n🔖┇ جاري انشاء الكونفك :\n🔖┇ خلي ايديك والتوكن واسم البوت ومعرفك كمطور \n🔖┇ V1 وسوف يتم  تشغيل  السورس الدولة توكن الاصدار  ")
    create_config()
  else
    f:close()
  end
...
function bot_run()
	...
	bot = bot.result
	local runlog = "🔖┇ معرف بوتك : @"..bot.username.."\n	🔖┇ يعمل ع سورس الدولة توكن الاصدار V1\n🔖┇ تابع قناه السورس @TH3VICTORY"
	print(runlog.."\n┇-----------------------------------")
